"""
Django settings for test_demo_eye_38817 project.
...
ROOT_URLCONF = 'test_demo_eye_38817.urls'
...
WSGI_APPLICATION = 'test_demo_eye_38817.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_demo_eye_38817 API",
    "DESCRIPTION": "API documentation for test_demo_eye_38817 App",
    "VERSION": "v1",
}
